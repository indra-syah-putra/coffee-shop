...
export default function AuthenticatedLayout({ header, children }) {
    ...
    return (
        <div className="min-h-screen bg-cream">
            <nav className="border-b border-gold/10 bg-espresso">
                    ...
                    <div className="flex h-16 justify-between">
                        ...
                        <div className="-me-2 flex items-center sm:hidden">
                            <button
                                ...
                                className="inline-flex items-center justify-center rounded-md p-2 text-cream/60 transition duration-150 ease-in-out hover:bg-light-brown/20 hover:text-cream focus:bg-light-brown/20 focus:text-cream focus:outline-none"
                            >
                                <svg
                                    className="h-6 w-6"
                                    stroke="currentColor"
