                        ...
                        {items.length === 0 ? (
                            ...
                            <>
                                ...
                                <div className="space-y-4 mb-8">
                                    {items.map(item => (
                                        <div key={item.id} className="bg-white rounded-2xl border border-gold/10 p-5 flex items-center gap-4">
                                ...
                                <div className="bg-white rounded-2xl border border-gold/20 p-6 sticky bottom-4">
                                    <div className="flex items-center justify-between mb-4">
                                        ...
                                        <span className="text-espresso font-bold">
                                            Total: <span className="text-gold text-xl ml-2">Rp {selectedTotal.toLocaleString('id-ID')}</span>
                                        </span>
                                    </div>
