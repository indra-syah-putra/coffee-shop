...
export default function PopularSection({ items = [], auth }) {
    ...
    return (
        <section
            id="popular"
            className="relative overflow-hidden bg-gradient-to-br from-espresso via-espresso/95 to-espresso/90 py-20"
        >
            ...
            <div className="relative z-10 mx-auto max-w-7xl px-6">
                <div className="mb-12 text-center">
                    ...
                    <h2 className="text-4xl font-bold text-white md:text-5xl">
                        Paling <span className="text-gold">Populer</span>
                    </h2>
                        ...
                        >
                            ...
                            <div className="relative h-56 w-full overflow-hidden sm:h-64">
                                <img
                                    ...
                                    alt={item.name}
                                    loading="lazy"
                                    onError={(e) => { e.target.src = 'data:image/svg+xml,%3Csvg xmlns="http://www.w3.org/2000/svg"%3E%3Crect fill="%23D4C5B5" width="100%"25 height="100%"25/%3E%3C/svg%3E' }}
